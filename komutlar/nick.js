...
const zeze = message;
if (!zeze.member.roles.has('790287813224562758')&& !zeze.member.hasPermission('ADMINISTRATOR')) return zeze.channel.sendEmbed(new Discord.RichEmbed().setDescription(' <@&rolidsi> Rolüne Sahip Olman Gerekiyor ❌').setColor("Black")); 
